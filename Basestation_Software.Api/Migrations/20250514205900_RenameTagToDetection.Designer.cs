...
namespace Basestation_Software.Api.Migrations
{
    ...
    [Migration("20250514205900_RenameTagToDetection")]
    partial class RenameTagToDetection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Basestation_Software.Models.Geospatial.GPSWaypoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "MDRS",
                            SearchRadius = 5.0,
                            Timestamp = new DateTime(2025, 5, 14, 15, 58, 59, 562, DateTimeKind.Local).AddTicks(661),
                            Type = 0,
                        ...
                        new
                        {
                            ...
                            Name = "SDELC",
                            SearchRadius = 5.0,
                            Timestamp = new DateTime(2025, 5, 14, 15, 58, 59, 562, DateTimeKind.Local).AddTicks(825),
                            Type = 0,
                            WaypointColor = -65536
                        });
                });

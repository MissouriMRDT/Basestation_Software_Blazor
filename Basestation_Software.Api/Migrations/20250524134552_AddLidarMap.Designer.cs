...
namespace Basestation_Software.Api.Migrations
{
    ...
    [Migration("20250524134552_AddLidarMap")]
    partial class AddLidarMap
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Basestation_Software.Models.Geospatial.GPSWaypoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "MDRS",
                            SearchRadius = 5.0,
                            Timestamp = new DateTime(2025, 5, 24, 8, 45, 51, 218, DateTimeKind.Local).AddTicks(6909),
                            Type = 0,
                        ...
                        new
                        {
                            ...
                            Name = "SDELC",
                            SearchRadius = 5.0,
                            Timestamp = new DateTime(2025, 5, 24, 8, 45, 51, 218, DateTimeKind.Local).AddTicks(7069),
                            Type = 0,
                            WaypointColor = -65536
                        });
                });

            modelBuilder.Entity("Basestation_Software.Models.Geospatial.LidarTile", b =>
                {
                    b.Property<int?>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

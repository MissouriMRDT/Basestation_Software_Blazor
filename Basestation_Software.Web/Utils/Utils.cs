...
public class Utils
{
    ...
    public static double ClampMap(double x, double in_min, double in_max, double out_min, double out_max)
    {
    ...
    public static int ClampMap(double x, double in_min, double in_max, int out_min, int out_max)
    {
        if (x < in_min) x = in_min;
        else if (x > in_max) x = in_max;
        return Map(x, in_min, in_max, out_min, out_max);
